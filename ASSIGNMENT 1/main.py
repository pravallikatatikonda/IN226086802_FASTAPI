...
products = [
    ...
    {"id": 3, "name": "Wireless Mouse", "price": 500, "category": "Electronics", "in_stock": True},
    {"id": 4, "name": "Headphones", "price": 1200, "category": "Electronics", "in_stock": False},

    # Q1: Added 3 more products
